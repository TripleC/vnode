YAHOO.util.Event.addListener(window, "load", function() {
    ...
    YAHOO.util.Connect.asyncRequest('GET',window.location.protocol+'//'+window.location.host+'/cgi/server/cgi-bin/main.py?vmAction=stateAll',this.connectionCallback2,null)
    };
});
