        ...
        YAHOO.vnode.Basic1 = new function() {
            this.connectionCallback = {
                success:function(o) {
                    ...
                    resultsList: "Result",
                    fields: ["PhysicalHost", "VirtualHost", "ExpiryTime",   "Memory",
                             "Partition",    "OSImage",     "ExpiryTimeAt", "Name"]
                    };
                    ...
                    this.myDataTable.subscribe( "cellDblclickEvent",
                                                this.myDataTable.onEventShowCellEditor);
                    this.myDataTable.subscribe( "editorBlurEvent", 
                                                this.myDataTable.onEventSaveCellEditor);
                    ...
                    var myColumnDefs = 
                    [ {key:"VirtualHost", sortable:true, 
                       sortOptions:{defaultDir:YAHOO.widget.DataTable.CLASS_DESC},resizeable:false},
                      {key:"gliteService1", formatter:YAHOO.widget.DataTable.formatDropdown, 
                       dropdownOptions:[{value:'none',                text: 'none'             },
                                        {value:'glite-UI',            text: 'glite-UI'         },
                       ...
                       resizeable:false},
                      {key:"gliteService2", formatter:YAHOO.widget.DataTable.formatDropdown,
                       dropdownOptions:[ {value:'none',                text:'none'},
                                         {value:'glite-UI',            text:'glite-UI'},
                                         {value:'glite-BDII_top',      text:'glite-BDII_top'},
                                         {value:'glite-BDII_site',     text:'glite-BDII_site'},
                      ...
                      {key:"gliteService3", formatter:YAHOO.widget.DataTable.formatDropdown, 
                       dropdownOptions:[ {value:'none',                text:'none'},
                                         {value:'glite-UI',            text:'glite-UI'},
                                         {value:'glite-BDII_top',      text:'glite-BDII_top'},
                                         {value:'glite-BDII_site',     text:'glite-BDII_site'},
                       ...
                       sortable:true, resizeable:false},
                      {key:"gliteService4", formatter:YAHOO.widget.DataTable.formatDropdown, 
                       dropdownOptions:[ {value:'none',                text:'none'},
                                         {value:'glite-UI',            text:'glite-UI'},
                                         {value:'glite-BDII_top',      text:'glite-BDII_top'},
                                         {value:'glite-BDII_site',     text:'glite-BDII_site'},
                       ...
                       sortable:true, resizeable:false},
                      {key:"gliteService5", formatter:YAHOO.widget.DataTable.formatDropdown, 
                       dropdownOptions:[ {value:'none',                text:'none'},
                                         {value:'glite-UI',            text:'glite-UI'},
                                         {value:'glite-BDII_top',      text:'glite-BDII_top'},
                                         {value:'glite-BDII_site',     text:'glite-BDII_site'},
                    ...
                    this.myDataTable3.subscribe('dropdownChangeEvent', function(oArgs) {
                            ...
                            setGlite( recordIndex, column.key,
            ...
            YAHOO.util.Connect.asyncRequest( 'GET', window.location.protocol + '//'
                                             + window.location.host 
                                             + '/cgi/server/cgi-bin/main.py?vmAction=getReservedData',
