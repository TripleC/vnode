...
Ext.onReady(function(){
    ...
    var storeHostnames = new Ext.data.Store({
          proxy: new Ext.data.HttpProxy({
              url: window.location.protocol+'//'+window.location.host+'/cgi/server/cgi-bin/main.py?vmAction=availableHostnames'
          }),
    ...
    var storePhysical = new Ext.data.Store({
          proxy: new Ext.data.HttpProxy({
              url: window.location.protocol+'//'+window.location.host+'/cgi/server/cgi-bin/main.py?vmAction=availablePhy'
          }),
          reader: new Ext.data.JsonReader({
              root: 'myData',
    ...
    var comboImageD = new Ext.form.ComboBox({
        store: storeImage,
        displayField:'osimage',
        typeAhead: true,
        editable: false,
    ...
    var comboServiceD = new Ext.form.ComboBox({
        store: servicesVM,
        displayField:'service',
        typeAhead: true,
        editable: false,
    ...
    var storeSiteNames = new Ext.data.Store({
          proxy: new Ext.data.HttpProxy({
              url: window.location.protocol+'//'+window.location.host+'/cgi/server/cgi-bin/main.py?vmAction=userSiteNames'
          }),
          reader: new Ext.data.JsonReader({
              root: 'myData',
              fields:  [{name: 'site'}]
