...
class VNodeLogger:
    ...
    def __init__(self):
        ...
        self.__setupFileOutput('../logs/vnode-node.log')
    ...
    def __setupSysLogOutput(self):
        ...
        #formatter = logging.Formatter('vNode: %(levelname)s %(funcName)s: %(message)s')   # broken in python 2.4
        formatter = logging.Formatter('vNode: %(levelname)s: %(message)s')
    ...
    def __setupFileOutput(self, logFilename):
        ...
        try:
            ...
            #formatter = logging.Formatter('%(asctime)s %(levelname)s %(funcName)s: %(message)s')  # broken in python 2.4
